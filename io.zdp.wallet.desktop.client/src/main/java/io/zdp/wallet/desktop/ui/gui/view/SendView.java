		...
		sendPanel.btnSend.addActionListener(e -> {
			...
			panel.btnTransfer.addActionListener(ev -> {
				...
				try {
					...
					SubmitTransactionResponse transferResponse = zdp.transfer(wallet.getPrivateKey(), Curves.DEFAULT_CURVE, panel.txtFrom.getText(), panel.txtTo.getText(), amountToSend, panel.txtMemo.getText());
